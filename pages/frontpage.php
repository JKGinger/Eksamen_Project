      ...
      <div class="container h-100">
        <div class="d-flex h-100 text-center align-items-center">
          <div class="w-100 text-white">
            ...
            <p class="lead mb-0">A website for learning the world around Minecraft</p>
          </div>
        </div>
      </div>
    </header>

<!--MINECRAFT NEWS SECTION-->
    <section>
      <h2 id="news">Minecraft news</h2>
      <div class="row align-items-sm-center minecraft-update">
        
          <div class="col-md minecraft-pics">
            <a href="https://www.minecraftforum.net/news/60771-java-edition-snapshot-20w18a" target="blank">
              <img
        ...
        <div class="col-md minecraft-pics">
          <a href="https://www.minecraftforum.net/news/60770-beta-bedrock-1-16-0-58-xbox-one-windows-10-android" target="blank">
            <img
        ...
        <div class="col-md minecraft-pics">
          <a href="https://www.minecraftforum.net/news/60767-minecraft-with-rtx-beta-is-now-live" target="blank">
            <img
